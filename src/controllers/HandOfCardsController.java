...
public class HandOfCardsController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        deck.shuffle();
        card1ImageView.setImage(deck.dealTopCard().getCardImage()); //ask the deck object to deal top card which
        //becomes a card object then I ask that card to give me the image to set in this image view
